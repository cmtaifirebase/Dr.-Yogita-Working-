  ...
  return (
    <motion.main initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-24">
      <section className="relative h-screen w-full">
        <Image src="/podcast image.jpg" alt="Podcast Cover" fill className="object-cover" priority />
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-md">
            <Image
              ...
              width={500}
              height={300}
              className="rounded-t-lg object-cover min-h-[350px]"
            />
            <div className="p-5">
              <h3 className="mb-2 text-xl font-semibold tracking-tight text-gray-900">
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-md">
            <Image
              src="/Posture Correction.jpeg"
              alt="Episode 3"
              width={500}
              height={300}
              className="rounded-t-lg object-cover min-h-[370px]"
            />
            <div className="p-5">
              <h3 className="mb-2 text-xl font-semibold tracking-tight text-gray-900">
