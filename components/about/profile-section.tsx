      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-pink-600 font-medium mb-6">Founder & Chief Physiotherapist</p>
            <p className="text-gray-600 mb-6">
              With over 22 years of distinguished experience, Dr. Yogita Kumari is a leading physiotherapist specializing
